...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.79    // Unit: mm compression per 1mm/s extruder speed
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_UNLOAD_PURGE_FEEDRATE      10  // (mm/s) Unload filament feedrate. This can be pretty fast.
